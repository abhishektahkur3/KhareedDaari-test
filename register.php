            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="register-form">
                    ...
                    <form action="register.php" method="post" enctype="multipart/form-data" id="logform">
                        ...
                        <div class="group-input">
                            <label for="con-pass">Pincode *</label>
...
if (isset($_POST['register'])) {
    ...
    if (in_array($fileType, $allow)) {
        if (move_uploaded_file($_FILES['pimage']['tmp_name'], $targetPath)) {
            $insert_c = "INSERT INTO customer (customer_name,customer_email,customer_pass,customer_address, Pin_Code, customer_contact,customer_image)
            VALUES('$c_name','$c_email','$c_pass','$c_address', '$c_pincode','$c_contact','$fileName')";
